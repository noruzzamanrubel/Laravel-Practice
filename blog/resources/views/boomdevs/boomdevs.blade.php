            ...
            <div class="row">
                <div class="col-lg-8 col-md-10 mx-auto">
                    <div class="site-heading">
                        <h1>Welcome to Boomdevs</h1>
                        <span class="subheading">We Create WordPress Plugins,
                            Themes & Custom Web Solutions</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="clearfix text-center">
                    <a href="{{route('add.developer')}}" class="btn btn-info">All Developers</a>
                </div>
            </div>
        </div>
    </div>
